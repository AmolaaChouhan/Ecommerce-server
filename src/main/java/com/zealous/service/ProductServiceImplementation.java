...
import com.zealous.model.Category;
import com.zealous.model.Product;
import com.zealous.repository.CategoryRepository;
import com.zealous.repository.ProductRepository;
import com.zealous.request.CreateProductRequest;
//import com.zealous.user.domain.ProductSubCategory;
@Service
...
Optional<Product> opt=productRepository.findById(id);
	...
	public List<Product> searchProduct(String query) {
		List<Product> products=((ProductServiceImplementation) productRepository).searchProduct(query);
		return products;
	}
